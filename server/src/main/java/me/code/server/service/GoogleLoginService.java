...
public class GoogleLoginService {
    ...
    public GoogleLoginService(GoogleOpaqueTokenIntrospector introspector, UserRepository userRepository, UserDetailsServiceImpl userDetailsService, JwtProvider jwtProvider, PasswordEncoder passwordEncoder) {
