<template>
    <section class="space-y-3 p-4 pb-[7rem]">
        <div class="mb-5">
            <p class="text-gray-400">Last updated: January 21, 2024</p>
            ...
            <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
                ...
                help of the
                <a class="font-semibold" href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank">Privacy
                    Policy Generator</a>.
            </p>
        </div>
        <h2 class="font-bold">Interpretation and Definitions</h2>
        ...
        <ul class="space-y-4 border border-gray-700 p-4 rounded">
            <li>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or
                    &quot;Our&quot; in this Agreement) refers to Blog Community LLC, Blogggatan 3B, 28179 Lund.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Blog Community, accessible from <a href="http://localhost:5173"
                        rel="external nofollow noopener" target="_blank">http://localhost:5173</a></p>
            </li>
            <li>
        ...
        <div class="space-y-3">
            <h2 class="font-bold">Collecting and Using Your Personal Data</h2>
        ...
        <p class="font-semibold">The Company may use Personal Data for the following purposes:</p>
        <ul class="space-y-4 border border-gray-700 p-4 rounded">
            <li>
        ...
        <p class="font-bold">We may share Your personal information in the following situations:</p>
        <ul class="space-y-4 border border-gray-700 p-4 rounded">
        ...
        <h3 class="font-semibold">Transfer of Your Personal Data</h3>
        ...
        <h3 class="font-semibold">Delete Your Personal Data</h3>
        ...
        <ul>
            <li>By email: info@blogcommunity.se</li>
        </ul>
    </section>
</template>
